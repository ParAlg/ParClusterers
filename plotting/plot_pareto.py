...
def plot_uci():
  ...
  df = pd.concat([df_pcbs,df_snap]) #,  df_neo4j, df_tg, df_nk
  ...
  our_methods = ['KCoreClusterer', 'LDDClusterer', 'SCANClusterer', 'LabelPropagationClusterer',
  ...
  plt.tight_layout()
  plt.savefig(base_addr + "time_f1_uci.pdf", bbox_inches='tight')
  print("plotted time_f1_uci.pdf")


  # Plot Precision Recall Pareto frontier for modularity methods
  ...
  plotPRPareto(df_pr_pareto)
  plt.tight_layout()
  plt.savefig(base_addr + "pr_uci_modularity.pdf", bbox_inches='tight')
  print("plotted pr_uci_modularity.pdf")
