...
def runTectonic(clusterer, graph, graph_idx, round):
  ...
  runner_utils.shellGetOutput(gcc_ver + " -std=c++11 -o external/Tectonic/tree-clusters external/Tectonic/tree-clusters.cpp")
  # Timing from here
  ...
  runner_utils.shellGetOutput("external/Tectonic/tree-clusters " + out_prefix + ".weighted " + num_vert + " > " + out_clustering)
  end_time = time.time()
