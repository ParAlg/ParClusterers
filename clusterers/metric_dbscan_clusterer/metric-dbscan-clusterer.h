...
#ifndef PARALLEL_CLUSTERING_CLUSTERERS_METRIC_DBSCAN_CLUSTERER_H_
#define PARALLEL_CLUSTERING_CLUSTERERS_METRIC_DBSCAN_CLUSTERER_H_
...
class MetricDBSCANClusterer : public InMemoryMetricClusterer {
 public:
