...
#ifndef PARALLEL_CLUSTERING_CLUSTERERS_KCORE_CLUSTERER_H_
#define PARALLEL_CLUSTERING_CLUSTERERS_KCORE_CLUSTERER_H_
...
class KCoreClusterer : public InMemoryClusterer {
 public:
